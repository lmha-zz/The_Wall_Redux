class User < ActiveRecord::Base
  ...
  # using attr_accessor allows my form to contain a password field and use it on the model side, even though there is no field in my database called password (we used encrypted_password)
  ...
  # this method encrypts the users' unencrypted login attempt and returns true if the password is a match
  ...
  def encrypt_password
    ...
    # self.password uses the attr_accessor defined above to allow me to grab the inputed password
  ...
  # encrypt the passsword using both the sal tand the passed password
  def encrypt(pass)
